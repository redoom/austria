...
import evolutionOfImmigration from '../data/evolutionOfImmigration.json';
import inflowImmigrationContinent from '../data/inflowImmigrationContinent.json';
import openingNetwork from '../data/openingNetwork.json';
...
const Tab1: React.FC = () => {
  ...
  const changeData = (id: string) => {
    ...
    switch (id) {
      case "Inflow":
        setSelectedData(inflowImmigrationContinent)
      ...
      default:
        setChartType("BUMP")
        setSelectedData(evolutionOfImmigration)
        setTitleText("The evolution of immigration numbers")
        break;
  }
  }

  const [selectedData, setSelectedData] = useState(evolutionOfImmigration);
